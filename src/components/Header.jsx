...
export default function Header({
  ...
  return (
    <header className="fixed top-0 right-0 h-16 bg-white dark:bg-gray-800 shadow-lg border-b border-gray-200 dark:border-gray-700 z-40 transition-all duration-300"
      ...
      <div className="flex items-center justify-between h-full px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={`h-4 w-4 absolute top-1 ${darkMode ? 'left-2' : 'right-2'} text-yellow-500 dark:text-blue-300`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
