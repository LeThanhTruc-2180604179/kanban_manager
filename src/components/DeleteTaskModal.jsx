    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-sm">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-4">
          Deleting is irreversible. It permanently removes the task and its subtasks.
        </p>
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full p-2 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 ${
              confirmationText.toLowerCase() === 'delete' ? 'text-red-500 dark:text-red-500' : 'text-gray-800 dark:text-white'
            }`}
            placeholder="delete"
          />
        </div>
        <div className="flex justify-end space-x-3">
          ...
          <button
            ...
            className={`px-4 py-2 rounded text-white ${
              confirmationText.toLowerCase() === 'delete' ? 'bg-red-600 hover:bg-red-700' : 'bg-red-300 cursor-not-allowed'
            }`}
          >
            Delete
          </button>
